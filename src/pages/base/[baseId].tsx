    ...
    <div className="h-screen flex">
      ...
      <div className="h-screen flex flex-col flex-1">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <aside className="w-56 bg-white border-r p-3 flex flex-col gap-2 text-sm">
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex items-center bg-[#fff9e8] border-b border-gray-200 px-4 py-2 text-sm relative">
              ...
              <div className="ml-auto text-gray-600 text-sm">Tools ▼</div>
            </div>

            {/* Main Table */}
            <main ref={tableRef} className="flex-1 overflow-auto bg-gray-50 p-6">
              {isTableLoading ? (
